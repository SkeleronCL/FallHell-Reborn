...
{
	public class MoltenChainsawP : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextBool(10)) {
				Dust dust = Dust.NewDustDirect(Projectile.position + Projectile.velocity * Main.rand.Next(6, 10) * 0.15f, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 80, Color.OrangeRed, 1f);
				dust.position.X -= 5f;
				dust.noGravity = true;
